var setup = function()
{
    ...
    try{
        ...
        var _regform=$('#hdn_regform_edit').val();
    _regform=JSON.parse(_regform);
    
    
        schema=_regform.schema;
        options=_regform.options;
        data=_regform.data;
    }catch(e){}
...
//    $(".save-button").off().click(function() {
    $("[name=frmevent]").on().submit(function() {
