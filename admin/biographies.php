<?php include('inc/header.php'); ?>
    ...
    <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php
                        ...
                        $categories=get_all_biographies("eventid=$_top_event_id");
                        for($i=0;$i<sizeof($categories);$i++){
                    ?>
                        <tr>
                            <td><?=$categories[$i]['title']?></td>
                            <td><?=$categories[$i]['position']?></td>
                            <td><?=$categories[$i]['description']?></td>
                            <td><?=$categories[$i]['statusname']?></td>
                            <td><?=action_buttons('addbiography.php','addbiography.php','addbiography.php',$categories[$i]['id'])?></td>
                        </tr>                      
                    <?php
                        }
                    ?>
