                  ...
                  <div class="box-body">
                   <div class="form-group">
                    <label>Templates</label>
                        <select class="form-control select2" style="width: 100%;" name="ddl_templates" onchange="selectTemplate(this)">
                    ...
                    <div class="form-group">
                      ...
                      <input disabled type="text" class="form-control" name="txt_title" id="txt_title" placeholder="Enter Subject">
                    </div>   
                    <div class="form-group">
                      <label for="txt_role_name">Content</label>
                      <textarea disabled  class="form-control email_content" id="txt_content" name="txt_content" placeholder="Enter Content" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                    </div>  
                    <div class="checkbox">
                      <label>
