<?php
    ...
    function get_all_events($where=''){
        ...
        $qry="select * ,case when status=1 then 'Active' else 'In Active' end 'statusname' from tbl_eventsnew c $_where order by id desc";
        $result = mysqli_query($conn, $qry);
    ...
    function get_all_helpdesks($where=''){
        global $conn;
        $_where='';
        if($where!='')
        {
        ...
        $qry="select *  from tbl_helpdesk c $_where order by id desc";
        $result = mysqli_query($conn, $qry);
    ...
    function get_all_helpdesks2($where=''){
        global $conn;
        $_where='';
        if($where!='')
        {
      ...
      $qry="select c.*,p.title  from tbl_helpdesk c inner join tbl_poster p on c.pid=p.Id $_where order by id desc";
        $result = mysqli_query($conn, $qry);
    ...
    function get_all_posters($where=''){
        ...
        $qry="SELECT *,case when p.status=1 then 'Active' else 'In Active' end 'statusname',c.catname FROM `tbl_poster` p inner join tbl_categories c on p.category=c.catid $_where order by p.Title desc";
        $result = mysqli_query($conn, $qry);
    ...
    function get_all_userevents($where=''){
        global $conn;
        $_where='';
        if($where!='')
        {
        ...
        $qry="select *  from tbl_user_event c $_where order by id desc";
        $result = mysqli_query($conn, $qry);
     ...
     function get_all_templates($where=''){
        global $conn;
        $_where='';
        if($where!='')
        {
        ...
        $qry="SELECT *,case when status=1 then 'Active' else 'In Active' end 'statusname' FROM `tbl_email_templates`  $_where order by 1 desc";
        $result = mysqli_query($conn, $qry);
    ...
    function get_all_exhibitors_new($where=''){
        global $conn;
        $_where='';
        if($where!='')
        {
         ...
         $qry="SELECT * FROM `tbl_exhibitor_new`  $_where order by 1 desc";
        $result = mysqli_query($conn, $qry);
