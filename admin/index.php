<?php
    ...
    if(isset($_POST['btn_login'])){
        ...
        $qry="select u.*,p.firstname,p.lastname,p.email,r.role from tbl_users u 
              ...
              where username='$txt_username' and password='$txt_password'";
            ...
            while($row = mysqli_fetch_assoc($result)) {                
                if($row["username"]==$txt_username && $row["password"]==$txt_password){
                   ...
                   // header("location:dashboard.php");
                    ...
                    else if($_SESSION['userdata']['roleid']==10)
                    {
      ...
      // output data of each row
          while($row = mysqli_fetch_assoc($result)) {                
              if($row["username"]==$txt_username && $row["password"]==$txt_password){
                  ...
                  $hdn_returnurl=(isset($hdn_returnurl))?$hdn_returnurl:"../home.php";  
                  header("location:$hdn_returnurl");
              }
              else
              {
                  $msg="Invalid Username/Password";        
...
<html>
  <head>
    ...
    <title>Virtual Conference System | Admin Panel</title>
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <!--<a href="../../index2.html">--><b>Virtual</b> Conference System<!--</a>-->
      </div><!-- /.login-logo -->
